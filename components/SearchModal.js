...
const SearchModal = ({
  ...
  const renderStationItem = useCallback(
    ...
    [currentStation?.id, handleStationPress, isPlaying, isRTL, language, styles]
  );
      ...
      <View style={[styles.searchContainer, isRTL && styles.rtlSearchContainer]}>
        ...
        <View style={[styles.searchHeader, isRTL && styles.rtlSearchHeader]}>
          ...
          <View style={[styles.searchInputContainer, isRTL && styles.rtlSearchInputContainer]}>
            <Ionicons name="search" size={20} color="#ffffff" style={[styles.searchIcon, isRTL && styles.rtlSearchIcon]} />
            <TextInput
            ...
            {searchQuery.length > 0 && (
              <TouchableOpacity style={[styles.clearButton, isRTL && styles.rtlClearButton]} onPress={clearSearch}>
